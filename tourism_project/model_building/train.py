...
mlflow.set_tracking_uri("https://curled-reversal-mowing.ngrok-free.dev")   # complete the code to set the MLflow tracking URI
...
param_grid = {
    ...
    'xgbclassifier__learning_rate': [0.1],       # Step size used during boosting. Smaller values may improve generalization but require more trees.
    'xgbclassifier__reg_lambda': [1],          # L2 regularization strength. Higher values help reduce overfitting.
}
# Model pipeline
...
with mlflow.start_run():
    ...
    model_path = "tourism_project/deployment/model.joblib"   # Specify the local file path (inside tourism_project/deployment/) where the trained model should be saved.
